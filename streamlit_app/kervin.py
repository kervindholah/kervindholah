...
#    encoded_row = encoded_row.values.reshape(1, -1)
#    st.write(encoded_row)
#    scaler = StandardScaler()
#    encoded_row_scaled = scaler.fit_transform(encoded_row)
#    st.write(encoded_row_scaled)
#    prediction = ridge_model.predict(encoded_row_scaled)
...
#   scaler = StandardScaler()
#    new_encoded_row_scaled = scaler.fit_transform(new_encoded_row)
#    prediction = ridge_model.predict(new_encoded_row_scaled)
#    st.write("Résultat de la prédiction de Life Ladder :", prediction)
